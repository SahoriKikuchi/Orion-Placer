    ...
    <section class="info_section">
        <div class="container-info">
            ...
            <div class="box-i box-2">
                <h3>Informações</h3>
                <div>
                    <p style="font-size: 12px;">A tradicional Exposição Agropecuária, Industrial e Comercial de São João da Boa Vista (EAPIC), centraliza toda a tradição regional do agronegócio, sem deixar de lado o entretenimento ao público. São diversas opções de diversão para toda a família. Você não pode ficar de fora dessa!</p>

                </div>
                <h4>Endereço:</h4>
                <p style="font-size: 12px;">s/n Recinto de Exposicoes, Av. Sen. Marcos Freire - Vila Brasil, São João da Boa Vista - SP</p>
                <div class="size-img-inf">
