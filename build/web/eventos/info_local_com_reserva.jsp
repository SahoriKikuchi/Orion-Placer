<%-- 
    Document   : info_local_com_reserva
    Created on : 7 de nov. de 2022, 18:50:01
    Author     : amand
--%>
...
<body>
    ...
    -->
            <ul class="nav navbar-nav navbar-right">
                <li><a href="perfilPF.jsp"><span class="glyphicon glyphicon-user"></span></a></li>
        ...
        <div class="container-info">
            ...
            <div class="box-i box-4">
                <div>
                    ...
                    <a class="btn-box"href="reserva.jsp">
