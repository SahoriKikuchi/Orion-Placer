...
public class ClassificacaoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Classificacao u = new Classificacao();
        u.setClassificacao("Pubs & Bares");
        dao.salvar(u);
        u.setClassificacao("Festas Universitárias");
        dao.salvar(u);
        u.setClassificacao("Restaurantes");
        dao.salvar(u);
        u.setClassificacao("Eventos");
        dao.salvar(u);
        u.setClassificacao("Atividade Recreativa");
        dao.salvar(u);
