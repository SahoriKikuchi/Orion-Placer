<%-- 
    ...
    Created on : 7 de nov. de 2022, 18:36:03
    Author     : amand
--%>
    ...
    <section class="info_section">
        <div class="container-info">
            ...
            <div class="box-i box-2">
                ...
                <h4>Endereço:</h4>
                <p style="font-size: 12px;">Av. Dr. Durval Nicolau, 1210 - Parque Colina da Mantiqueira, São João da Boa Vista - SP, 13874-371</p>
                <div class="size-img-inf">
